...
class HistoryEventType(str, Enum):
    """Tipos de evento trazable — §5.4 (16 operaciones)."""
...
class Source:
    ...
    name: str = ""
    description: str = ""
    reference: str = ""          # internal or external reference
    fragment: str = ""           # associated fragment if applicable
    ...
    def touch(self) -> None:
        pass  # Sources don't auto-update timestamps
...
class HistoryEntry:
    ...
    def touch(self) -> None:
        pass  # History entries are immutable once created
