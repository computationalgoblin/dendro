...
EXPECTED_PARENTLESS_WIDGETS = {
    ...
    "hosts/DesktopHostPySide/views/workspaces.py:452:self.cards = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:512:self.cards = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:625:body = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:858:grid_host = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:886:self._layer_section = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:897:self._layer_chips_container = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:1497:self._chips_widget = QWidget()",
    "hosts/DesktopHostPySide/views/workspaces.py:1898:bar = QFrame()",
    "hosts/DesktopHostPySide/views/workspaces.py:2187:bar = QFrame()",
