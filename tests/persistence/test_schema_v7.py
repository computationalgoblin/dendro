...
class TestSchemaVersionV7:
    ...
    def test_max_supported_is_v9(self):
        assert MAX_SUPPORTED_VERSION == 18
...
class TestFutureVersionRejection:
    def test_v19_rejected(self, tmp_path: Path):
        path = tmp_path / "future.json"
        future = {"schema_version": 19, "id": "x", "name": "Future",
                   "created_at": "2026-01-01T00:00:00+00:00",
                   "updated_at": "2026-01-01T00:00:00+00:00"}
        ...
        assert "v18" in result.error or "schema" in result.error.lower()
